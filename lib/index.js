...
function isEither(obj) {
  return !!(obj !== undefined && obj !== null && (obj.Right || obj.Left));
}
 ...
 */
function isLeft() {
  return !!(isEither(this.val) && this.val.Left);
}

/**
 * Returns true if the current value of a stream is a Right value.
 *
 * @name stream.isRight
 * @return {Boolean}
 */
function isRight() {
  return !!(isEither(this.val) && this.val.Right);
}
