...
function isEither(obj) {
  return obj !== undefined && obj !== null && obj.hasOwnProperty('left') &&
...
/**
 * Returns true if `n` is a Right or a plain value.
 *
 * @name stream.isRight
 * @return {Boolean}
 */
...
/**
 * Returns true if the current value of a stream is a Right or a plain value.
 *
 * @name stream.isRight
 * @return {Boolean}
 */
...
function createStream() {
  function s(n) {
    if (arguments.length === 0) {
      ...
      return s.val !== undefined && s.val.hasOwnProperty('right') ?
        s.val.right : s.val;
    }
